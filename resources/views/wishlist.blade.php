    ...
    <div class="container">
                ...
                <table class="wb-line-table">
                    ...
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td><a href="{{ route('products.show', ['id' => $product->id]) }}" class="wb-line__name">{{ $product->name }}</a></td>
                            ...
                            <td><a href="{{ route('cart.add', ['id' => $product->id]) }}" class="wb-btn wb-btn--sm wb-btn--accent">Add to Cart</a></td>
                            <td><a href="{{ route('wishlist.remove', ['id' => $product->id]) }}" class="wb-line__remove" aria-label="Remove"><x-icon name="trash" :size="17" /></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
        ...
        @else
            <div class="wb-empty-state">
                ...
                <a href="{{ route('shop') }}" class="wb-btn wb-btn--accent">Browse Products</a>
            </div>
        @endif
    </div>
</div>
