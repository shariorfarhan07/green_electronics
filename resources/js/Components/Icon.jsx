...
// The app's inline-SVG icon set. Every icon used anywhere lives here so
// pages use the exact same icon set as the remaining Blade pages.
const PATHS = {
...
export default function Icon({ name, size = 20, className = '', ...rest }) {
    ...
    return (
        <svg
            ...
            className={`wb-icon ${className}`.trim()}
            aria-hidden="true"
